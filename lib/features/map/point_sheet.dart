            ...
            children: [
              ...
              InkWell(
                onTap: message.locationPending
                    ? null
                    : () => unawaited(
                        _copyCoords(context, message, l10n.mapCoordsCopied),
                      ),
                child: Row(
                  children: [
                    const Icon(
